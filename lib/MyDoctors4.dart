...
import './MyDoctors6.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class MyDoctors4 extends StatelessWidget {
  MyDoctors4({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 215.0, middle: 0.5188),
            Pin(size: 22.0, middle: 0.5225),
            child: Text(
              'Selected Date 23/06/2021',
              style: TextStyle(
                fontFamily: 'Lato',
                fontSize: 18,
                color: const Color(0xff000000),
          ...
          Pinned.fromPins(
            Pin(size: 168.0, middle: 0.4928),
            Pin(size: 53.0, middle: 0.7329),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
...
const String _svg_vyzkqb =
    '<svg viewBox="109.0 256.0 20.7 19.6" ><path transform="translate(109.0, 256.0)" d="M 0 0 L 20.7382640838623 0 L 20.7382640838623 19.64677810668945 L 0 19.64677810668945 L 0 0 Z" fill="#00ac28" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
