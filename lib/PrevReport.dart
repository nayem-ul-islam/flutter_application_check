...
class PrevReport extends StatelessWidget {
  PrevReport({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 130.0, start: 11.0),
                  Pin(size: 68.0, middle: 0.391),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(size: 87.0, start: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 144.0, start: 11.0),
                  Pin(size: 68.0, middle: 0.8271),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(size: 87.0, start: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 58.0, start: 11.0),
                  Pin(size: 19.0, middle: 0.4419),
                  child: Text(
                    'Right Eye',
                    style: TextStyle(
                      fontFamily: 'Segoe UI',
                ...
                Pinned.fromPins(
                  Pin(size: 62.0, start: 11.0),
                  Pin(size: 19.0, middle: 0.6889),
                  child: Text(
                    'Treatment',
                    style: TextStyle(
                      fontFamily: 'Segoe UI',
          ...
          Pinned.fromPins(
            Pin(size: 125.0, start: 30.0),
            Pin(size: 17.0, end: 232.0),
            child: Text(
