                                                                              ...
                                                                              Pinned.fromPins(
                                                                                ...
                                                                                child: Container(
                                                                                  decoration: BoxDecoration(
                                                                                    ...
                                                                                    color: const Color(0xff27b2ff),
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                              Pinned.fromPins(
                                                                                Pin(size: 0.9, start: 0.1),
                                                                                Pin(start: 0.1, end: 0.3),
                                                                                child: Container(
                                                                                  decoration: BoxDecoration(
                                                                                    borderRadius: BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
                                                                                    color: const Color(0xff5cceff),
                                                                                  ),
                                                                                ),
                                                                              ),
                                                                              Pinned.fromPins(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              ...
                              Pin(start: 0.0, end: 46.0),
                              child:
                                  // Adobe XD layer: 'h0g0JZ8dZAYFRBYXMRK…' (shape)
                                  Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5.0),
                                  image: DecorationImage(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              ...
                              Pin(start: 0.0, end: 46.0),
                              child:
                                  // Adobe XD layer: 'bashundhara-paper-n…' (shape)
                                  Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5.0),
                                  image: DecorationImage(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              ...
                              Pin(start: 0.0, end: 46.0),
                              child:
                                  // Adobe XD layer: '41Pb-fYOqeL._SY450_' (shape)
                                  Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5.0),
                                  image: DecorationImage(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              ...
                              Pin(start: 0.0, end: 46.0),
                              child:
                                  // Adobe XD layer: 'istockphoto-1211282…' (shape)
                                  Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5.0),
                                  image: DecorationImage(
...
const String _svg_kjwy93 =
    '<svg viewBox="81.5 125.5 80.0 1.0" ><path transform="translate(81.5, 125.5)" d="M 0 0 L 80 0" fill="none" stroke="#404040" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_hlvzfl =
    '<svg viewBox="174.5 125.0 80.0 1.0" ><path transform="translate(174.5, 125.0)" d="M 0 0 L 80 0" fill="none" stroke="#2171b5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
