...
class AllItemforMedicine extends StatelessWidget {
  AllItemforMedicine({
    required Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 24.5, middle: 0.2677),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => AllItems(),
                ),
              ],
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(size: 73.0, start: 2.5),
          ...
          Pinned.fromPins(
            Pin(size: 250.0, end: 55.0),
            Pin(size: 30.0, middle: 0.2025),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  ...
                  Pinned.fromPins(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(size: 45.0, middle: 0.5091),
                          Pin(size: 14.0, end: 3.0),
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromPins(
                                Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                  ...
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        ...
                        child:
                            // Adobe XD layer: '2018-04-07_143028.9…' (shape)
                            Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.0),
                            image: DecorationImage(
                ...
                Pinned.fromPins(
                  Pin(size: 45.0, middle: 0.5167),
                  Pin(size: 14.0, end: 6.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
                  ...
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        ...
                        child:
                            // Adobe XD layer: 'seclo-40_l1' (shape)
                            Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.0),
                            image: DecorationImage(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        ...
                        Pin(start: 0.0, end: 46.0),
                        child:
                            // Adobe XD layer: 'Losectil-40mg' (shape)
                            Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.0),
                            image: DecorationImage(
...
const String _svg_d7n2gh =
    '<svg viewBox="81.5 125.5 80.0 1.0" ><path transform="translate(81.5, 125.5)" d="M 0 0 L 80 0" fill="none" stroke="#2171b5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_juy56m =
    '<svg viewBox="174.5 125.0 80.0 1.0" ><path transform="translate(174.5, 125.0)" d="M 0 0 L 80 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
