            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 30.0, middle: 0.1946),
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        ease: Curves.linear,
                        duration: 0.3,
                        pageBuilder: () => Treatment(),
                      ),
                    ],
                    child: Stack(
                      children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(start: 19.9, end: 13.0),
                  Pin(size: 29.4, middle: 0.5882),
                  child: PageLink(
                    links: [
                      PageLinkInfo(
                        transition: LinkTransition.Fade,
