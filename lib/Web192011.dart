...
class Web192011 extends StatelessWidget {
  Web192011({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 699.5, middle: 0.4998),
            Pin(size: 607.0, middle: 0.4863),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 258.0, middle: 0.5006),
                ...
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(start: 24.0, end: 23.5),
                        Pin(size: 196.0, end: 40.1),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 432.1, middle: 0.5012),
                  Pin(size: 42.0, middle: 0.7312),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(size: 257.0, start: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 292.1, middle: 0.5008),
                  Pin(size: 38.4, middle: 0.8004),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                      ...
                      Pinned.fromPins(
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              Pin(size: 310.0, middle: 0.5006),
                              Pin(size: 48.0, middle: 0.4815),
                              child: Text(
                                'VERIFY & PROCEED',
                                style: TextStyle(
                                  fontFamily: 'Segoe UI',
...
const String _svg_uu5wbs =
    '<svg viewBox="0.3 41.0 158.1 1.0" ><path transform="translate(0.35, 41.01)" d="M 0 0 L 158.1087188720703 0" fill="none" stroke="#ff1a00" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_2mkkmk =
    '<svg viewBox="0.7 38.4 291.4 1.0" ><path transform="translate(0.74, 38.41)" d="M 0 0 L 291.3966064453125 0" fill="none" stroke="#2171b5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
