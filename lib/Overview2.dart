    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 98.1, middle: 0.4837),
            Pin(size: 23.0, middle: 0.5404),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
