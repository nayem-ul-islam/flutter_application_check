...
class MyDoctors1 extends StatelessWidget {
  MyDoctors1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 154.0, start: 30.0),
            Pin(size: 58.0, middle: 0.2421),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 134.0, start: 30.0),
            Pin(size: 58.0, middle: 0.3619),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 189.0, start: 30.0),
            Pin(size: 58.0, middle: 0.5044),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 106.0, start: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 186.0, start: 30.0),
            Pin(size: 58.0, middle: 0.7667),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
