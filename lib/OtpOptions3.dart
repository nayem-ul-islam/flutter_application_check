...
class OtpOptions3 extends StatelessWidget {
  OtpOptions3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 16.0, middle: 0.2925),
            Pin(size: 40.0, middle: 0.4833),
            child: Text(
              '5',
              style: TextStyle(
                fontFamily: 'Segoe UI',
