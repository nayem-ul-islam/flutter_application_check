    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      color: const Color(0x66ff1a00),
                    ),
                  ),
                ),
                Pinned.fromPins(
                  Pin(size: 52.0, middle: 0.7668),
          ...
          Pinned.fromPins(
            Pin(size: 36.0, middle: 0.528),
            Pin(size: 14.0, middle: 0.268),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
...
const String _svg_oudiu5 =
    '<svg viewBox="266.5 92.0 90.0 1.0" ><path transform="translate(266.5, 91.98)" d="M 0 0 L 90 0" fill="none" stroke="#2171b5" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_2ooen5 =
    '<svg viewBox="63.5 92.0 100.9 1.0" ><path transform="translate(63.5, 91.98)" d="M 0 0 L 100.8816528320312 0" fill="none" stroke="#404040" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_irrw01 =
    '<svg viewBox="170.5 92.0 85.0 1.0" ><path transform="translate(170.5, 91.98)" d="M 0 0 L 85 0" fill="none" stroke="#404040" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
