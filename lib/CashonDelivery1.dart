...
class CashonDelivery1 extends StatelessWidget {
  CashonDelivery1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 258.0, middle: 0.5043),
            Pin(size: 48.0, middle: 0.4362),
            child: Text(
