      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 60.0, middle: 0.168),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => AddmoreAddress(),
                ),
              ],
              child: Container(
          ...
          Pinned.fromPins(
            Pin(size: 139.4, middle: 0.5008),
            Pin(size: 25.0, middle: 0.1869),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 23.3, end: 41.7),
            Pin(size: 30.0, middle: 0.4176),
            child:
